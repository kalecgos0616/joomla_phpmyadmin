...
<?php if ($this->params->get('show_page_title', 1)) : ?>
	<div class="componentheading<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>" style="<?php echo $direction; ?><?php echo $align; ?>"><span class="left"></span><?php echo $this->escape($this->params->get('page_title')); ?><span class="right"></span></div>
<?php endif; ?>
